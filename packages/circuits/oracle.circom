...
template OracleVerifier(max_header_bytes, max_body_bytes, n, k, pack_size, expose_from, expose_to) {
    ...
    // signal (twitter_regex_out, twitter_regex_reveal[max_body_bytes]) <== OracleRegex(max_body_bytes)(in_body_padded);
...
component main { public [ address ] } = OracleVerifier(1024, 1536, 121, 17, 31, 0, 0);
